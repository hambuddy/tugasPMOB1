...
import static com.example.tugasloginregister.R.id.edt_nim;
...
import com.example.tugasloginregister.data.AppDbProvider;
import com.example.tugasloginregister.data.User;
import com.example.tugasloginregister.data.UserDao;
...
public class WelcomeBack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefs = this.getSharedPreferences("267", Context.MODE_PRIVATE);
